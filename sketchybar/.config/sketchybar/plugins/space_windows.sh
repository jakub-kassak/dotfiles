...
reload_workspace_icon() {
  ...
  # else
  #   # number of apps in current current_workspace
  #   icon_strip="[$(aerospace list-windows --workspace $sid | wc -l | tr -d '[:space:]')]"
  # fi
...
if [ "$SENDER" = "aerospace_workspace_change" ]; then
  ...
  reload_workspace_icon "$AEROSPACE_PREV_WORKSPACE"    # "previous"
  reload_workspace_icon "$AEROSPACE_FOCUSED_WORKSPACE" # "focused"
